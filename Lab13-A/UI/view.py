...
class View(ft.UserControl):
    ...
    def load_interface(self):
        ...
        self.btn_analizza = ft.ElevatedButton(text="Analizza",on_click=self._controller.handle_vicini)

        row1 = ft.Row([self.ddyear,self.ddstato, self.btn_graph,self.btn_analizza],
